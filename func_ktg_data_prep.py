...
def ktg_data_prep():
    ...
    for eo in eo_list:
        ...
        maintanance_start_datetime = \
        full_eo_list.loc[full_eo_list['eo_code'] == eo, ['operation_start_date']].values[0][0]
        maintanance_finish_datetime = \
        full_eo_list.loc[full_eo_list['eo_code'] == eo, ['operation_finish_date']].values[0][0]
        ...
        eto_df = maintanance_jobs_df_selected_by_eo.loc[
            maintanance_jobs_df_selected_by_eo['maintanance_category_id'] == "eto"]
        ...
        maint_df = maintanance_jobs_df_selected_by_eo.loc[
            maintanance_jobs_df_selected_by_eo['maintanance_category_id'] != "eto"]
        # print(maint_df)
        maint_category_list = []
        for row in maint_df.itertuples():
            ...
            hour_df.loc[indexes_maint_job, ['maintanance_name']] = hour_df.loc[
                                                                       indexes_maint_job, ['maintanance_name']] + [
                                                                       [maintanance_name]]
    ...
    eo_data = full_eo_list.loc[:,
              ['eo_code', 'level_1', 'eo_model_name', 'eo_model_id', 'eo_description', 'teh_mesto', 'mvz',
               'constr_type', 'avearage_day_operation_hours_updated', 'operation_start_date',
               'avearage_day_operation_hours', 'operation_finish_date', 'eo_main_class_description']]
    ...
    model_eo_filter_list_raw = \
    ktg_by_month_data_df.groupby(['level_1', 'eo_model_name', 'eo_model_id'], as_index=False)['eo_model_id'].size()
